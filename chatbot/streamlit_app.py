...
from TeacherAssistantLlama2 import TeacherAssistantLlama2
from TeacherAssistantOpenAI import TeacherAssistantOpenAI


# Set up the Teacher Assistant

# To test llama2 comment out the openAI Teacher Assistant and uncomment the llama2 Teacher Assistant


#ta = TeacherAssistantLlama2([]) 
ta = TeacherAssistantOpenAI([])
completed_code = """
...
st.title("Teacher Assistant- Test")
st.write("This is a test of the Teacher Assistant chatbot.")
...
if question:
    ...
    st.session_state.messages.append({"role": "You", "text": question})

    # Use the `ta` object to get the answer
    answer = ta.query_chain(question=question, completed_code=completed_code, boilerplate=boilerplate)
