...
def add_project_to_db(project_name, project_description, completed_repo_url, template_repo_url):
...
add_project_to_db("test", "test", "test", "test")
print(get_all_projects_from_db())
print(get_project_from_db("test"))
delete_project_from_db("test")
